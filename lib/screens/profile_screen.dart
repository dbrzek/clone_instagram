...
import 'package:instagram_app_clone/resources/auth_methods.dart';
...
class ProfileScren extends StatefulWidget {
  ...
  const ProfileScren({Key? key, required this.uid}) : super(key: key);
...
class _ProfileScrenState extends State<ProfileScren> {
  ...
  getData() async {
    ...
    try {
      ...
      isFollowing = (userSnap.data()! as Map)['followers'].contains(userId);
      setState(() {});
    } catch (e) {
